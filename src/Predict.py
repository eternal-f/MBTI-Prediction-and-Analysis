...
def batch_predict(texts, device):
    ...
    predictions = []
    for text in texts:
        pred = predict(model, vocab, text, device)
...
if __name__ == '__main__':
    ...
    df['predicted_label'] = batch_predict(df['text'].tolist(), device)
    new_file = '../Output/final_predictions.csv'
